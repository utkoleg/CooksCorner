...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserResponseDTO followUser(UUID id, UUID userId) {
        User userToFollow = userRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("User not found"));
        User user = userRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("User not found"));
