...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendVerificationEmail(String to, String subject, String email) {
        try {
            ...
            helper.setFrom("utkoleg@mail.com");
    ...
    public String buildEmail(String name, String link, String type) {
        ...
        String btn = "";
        if(type == "email"){
            action = "Thank you for registering. Please click on the below link to activate your account";
            header = "Confirm your email";
            btn = "Activate now";
        } else if (type == "password") {
            action = "Password reset. Please click the below link to reset your password";
        ...
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                  <tbody><tr>\n" +
                "                    <td bgcolor=\"#fcb447\" width=\"100%\" height=\"10\"></td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "        \n" +
                "      </td>\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> " + action + ": </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">" + btn + "</a> </p></blockquote>\n <p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
